/// @description Add background
	...
	add_background(spr_bg_cgz_mountains, 0, 0.98, v_scroll, 0, 0, 0, 0);
	add_background(spr_bg_cgz_mountains, 1, 0.97, v_scroll, 0, 0, 0, 0);
	add_background(spr_bg_cgz_mountains, 2, 0.92, v_scroll, 0, 0, 0, 0);
	add_background_line(spr_bg_cgz_bottom, 0, 1.2, v_scroll, 0, 0, 0, 0, 2, 0.003);
	add_background(spr_bg_cgz_mountains, 3, 0.88, v_scroll, 0, 0, 0, 0);
	add_background(spr_bg_cgz_bottom, 1, 0.85, 2/3, 0, 0, 0, 166);
	add_background(spr_bg_cgz_bottom, 1, 0.82, 2/3, 0, 0, 0, 189);
	add_background(spr_bg_cgz_bottom, 1, 0.78, 2/3, 0, 0, 0, 212);
